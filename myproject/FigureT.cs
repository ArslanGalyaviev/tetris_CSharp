...
namespace myproject
{
    ...
    {
        public FigureT(Point start)
        {
            state = 0;
            Point cell1 = new Point(start.X, start.Y + 1);
            Point cell2 = new Point(start.X + 1, start.Y + 1);
            Point cell3 = new Point(start.X + 2, start.Y + 1);
            Point cell4 = new Point(start.X + 1, start.Y);
